...
1. Script Purpose:
   This script creates all required tables in the 'silver' schema, dropping any that already exist.

2. Warning Message:
   This script will permanently drop existing tables in the 'silver' schema. Ensure backups are in place.
*/
