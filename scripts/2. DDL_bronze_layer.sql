...
1. Script Purpose:
   This script creates all required tables in the 'bronze' schema, dropping any that already exist.

2. Warning Message:
   This script will permanently drop existing tables in the 'bronze' schema. Ensure backups are in place.
*/
...
-- Drop and create bronze.erp_lock_a101
